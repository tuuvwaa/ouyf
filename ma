...
local IslandTab = Window:AddTab({ Title = "Script Fix Lag", Icon = "" })
local ChestTab = Window:AddTab({ Title = "Script Nhặt Rương", Icon = "" })
...
MainTab:AddButton({
    Title = "Teddy Hub",
    Description = "Auto Hop Sever Boss",
    Callback = function()
...
PlayerTab:AddButton({
    Title = "Auto Bounty Dracov3 HoHo",
    Description = "Cần Get Key",
    Callback = function()
        _G["Tuấn Anh IOS AuTo Bounty"] = {
    ["Avatar"] = "rbxassetid://112455697889846",
